            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-logo-teal flex items-center justify-center">
                  <img src={imageConstants.LOGO} alt="Say Space Logo" className="w-8 h-8" />
                </div>
                <div>
                  <h2 className="text-xl font-semibold text-white">Say Space</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@sayspace.com" className="text-white hover:text-logo-beige transition-colors duration-200">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+9198765432" className="text-white hover:text-logo-beige transition-colors duration-200">
                      +91 98765432
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="max-w-xs">
                    ...
                    <p className="text-white text-sm leading-relaxed">
                      2nd Cross Road, 6th Main Road, Motappana, AppareddyPalya Rd, 
              ...
              <div className="flex space-x-4 pt-4">
                <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-logo-teal text-gray-400 hover:text-white flex items-center justify-center transition-all duration-200">
              ...
              <ul className="space-y-3">
                {quickLinks.map((link, index) => (
                  <li key={index}>
                    <a 
                      href={link.path} 
                      className="group text-gray-300 hover:text-white transition-colors duration-200 text-sm font-light flex items-center"
                    >
                      {link.name}
